...
module.exports = class create_monster {
  ...
  async run(bot, message, args) {
    ...
    Createmonster[monsterName] = {
      ...
      Monster_Drop_Material1_Chance: 1,
      Monster_Drop_Material2_Chance: 1,
      Monster_Drop_Material3_Chance: 1,
      Monster_Drop_Material4_Chance: 1,
      Monster_Drop_Material5_Chance: 1,
      Monster_Drop_Material6_Chance: 1,
